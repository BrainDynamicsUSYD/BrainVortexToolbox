function [classification_accuracy_avg, classification_accuracy_stderr, classification_accuracy] = spiral_classifer_timeseries_4conditions(flagRest,flagSur,hemisphere,main_folder,No_of_Subject,flagTask)
...
for subject = 1:No_of_Subject
    ...
    cd(foldername)
    name = dir(['/import/headnode2/yixu4976/Downloads/fMRI/TaskLabel']) ;   
