...
switch methodNum
    ...
    case 6
        ...
        surSigTemp = nan(size(sigOriTemp)); % added later, to make sure the 'surSigTemp' are in correct size
...
%         surSigTemp_size = size(surSigTemp);
%      save(['/import/headnode2/yixu4976/Downloads/fMRI/Data_Raw/toolbox/preprocess/','surSigTemp_size.mat'],'surSigTemp_size');
